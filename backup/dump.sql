...
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',1,1);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',2,1);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',3,2);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',4,2);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',5,3);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',6,3);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',7,4);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',8,4);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',2,5);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',1,5);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-01',4,6);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-01',7,6);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',1,1);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',2,1);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',3,2);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',4,2);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',5,3);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',6,3);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',7,4);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',8,4);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',2,5);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',1,5);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (1,'2023-02-02',4,6);
insert into aula (chamada, data, disciplina_codigo, turma_id) values (2,'2023-02-02',7,6);
...
insert into faltas (aluno_tia, aula_id) values (445035,1);
insert into faltas (aluno_tia, aula_id) values (445035,2);
insert into faltas (aluno_tia, aula_id) values (445035,14);
insert into faltas (aluno_tia, aula_id) values (606569,3);
insert into faltas (aluno_tia, aula_id) values (606569,17);
...
INSERT INTO turma (ano, codigo) VALUES (1,'1A');
INSERT INTO turma (ano, codigo) VALUES (1,'1B');
INSERT INTO turma (ano, codigo) VALUES (2,'2A');
INSERT INTO turma (ano, codigo) VALUES (3,'3A');
INSERT INTO turma (ano, codigo) VALUES (4,'4A');
INSERT INTO turma (ano, codigo) VALUES (5,'5A');
